...
func init() {
	...
	scionFlags :=[]cli.Flag{
		utils.BootnodesFlagSCION,
		utils.SCIONFlag,
		utils.SCIONDaemonPathFlag,
		utils.SCIONTestRunFlag,
		utils.SCIONPathDictionaryLocationFlag,
		utils.CustomStatsPathFlag,
	}
	...
	app.Flags = append(app.Flags, scionFlags...)
...
func version(ctx *cli.Context) error {
	...
	fmt.Println("Supported Scionproto Commit: 6684764d64424ca85665b48c1a7025a71f98ab59")
	return nil
}
