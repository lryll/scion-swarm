...
// Source: lib/snet/internal/pathsource/pathsource.go
...
func (m *MockPathSource) Get(ctx context.Context, src, dst addr.IA) (*overlay.OverlayAddr, *spath.Path, error) {
	ret := m.ctrl.Call(m, "Get", ctx, src, dst)
...
func (mr *MockPathSourceMockRecorder) Get(ctx, src, dst interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockPathSource)(nil).Get), ctx, src, dst)
}
