...
//SCIONAddr with udp port for discovery only
type ScionAddrUDP string

func (v ScionAddrUDP) ENRKey() string {return "sAddrUDP"}

// SQUIC is the squic key, which holds the QUIC port of the node
type SQUIC uint16

func (v SQUIC) ENRKey() string {return "squic"}
